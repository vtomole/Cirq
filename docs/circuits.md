...
Cirq, qubits are represented by subclasses of the `QuditId`
base class. Different subclasses of `QuditId` can be used
...
subclasses `QuditId`.   For example, we can create
