...
class QubitOrder:
    ...
    def __init__(self, explicit_func: Callable[[Iterable[raw_types.QuditId]],
                                               Tuple[raw_types.QuditId, ...]]
                 ) -> None:
    ...
    @staticmethod
    def explicit(fixed_qubits: Iterable[raw_types.QuditId],
    ...
    @staticmethod
    def sorted_by(key: Callable[[raw_types.QuditId], Any]) -> 'QubitOrder':
    ...
    def order_for(self, qubits: Iterable[raw_types.QuditId]
                  ) -> Tuple[raw_types.QuditId, ...]:
