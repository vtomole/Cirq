...
class GateOperation(raw_types.Operation):
    ...
    def __init__(self,
                 gate: raw_types.Gate,
                 qubits: Sequence[raw_types.QuditId]) -> None:
        """
        Args:
    ...
    def with_qubits(self, *new_qubits: raw_types.QuditId) -> 'GateOperation':
    ...
    def _group_interchangeable_qubits(self) -> Tuple[
            Union[raw_types.QuditId,
                  Tuple[int, FrozenSet[raw_types.QuditId]]],
            ...]:

        if not isinstance(self.gate, gate_features.InterchangeableQubitsGate):
            return self.qubits

        groups = {}  # type: Dict[int, List[raw_types.QuditId]]
