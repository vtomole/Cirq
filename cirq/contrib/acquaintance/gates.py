...
def acquaint_and_shift(parts: Tuple[List[ops.QuditId], List[ops.QuditId]],
                       layers: Layers,
...
class SwapNetworkGate(PermutationGate):
    ...
    @staticmethod
    def from_operations(qubit_order: Sequence[ops.QuditId],
