...
class PauliStringPhasor(PauliStringGateOperation):
    ...
    def map_qubits(self, qubit_map: Dict[ops.QuditId, ops.QuditId]):
...
def xor_nonlocal_decompose(qubits: Iterable[ops.QuditId],
                           onto_qubit: ops.QuditId) -> Iterable[ops.Operation]:
