...
def two_qubit_matrix_to_operations(q0: ops.QuditId,
                                   q1: ops.QuditId,
                                   mat: np.ndarray,
...
def _xx_interaction_via_full_czs(q0: ops.QuditId,
                                 q1: ops.QuditId,
                                 x: float):
    a = x * -2 / np.pi
    yield ops.H(q1)
...
def _xx_yy_interaction_via_full_czs(q0: ops.QuditId,
                                    q1: ops.QuditId,
                                    x: float,
                                    y: float):
    a = x * -2 / np.pi
...
def _xx_yy_zz_interaction_via_full_czs(q0: ops.QuditId,
                                       q1: ops.QuditId,
                                       x: float,
                                       y: float,
                                       z: float):
...
def _kak_decomposition_to_operations(q0: ops.QuditId,
                                     q1: ops.QuditId,
...
def _parity_interaction(q0: ops.QuditId,
                        q1: ops.QuditId,
                        rads: float,
                        tolerance: float,
...
def _do_single_on(u: np.ndarray, q: ops.QuditId, tolerance: float=1e-8):
    for gate in decompositions.single_qubit_matrix_to_gates(u, tolerance):
        yield gate(q)


def _non_local_part(q0: ops.QuditId,
                    q1: ops.QuditId,
